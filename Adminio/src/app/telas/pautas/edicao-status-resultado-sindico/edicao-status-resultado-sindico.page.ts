...
@Component({
  selector: 'app-edicao-status-resultado-sindico',
  templateUrl: './edicao-status-resultado-sindico.page.html',
  styleUrls: ['./edicao-status-resultado-sindico.page.scss'],
})
export class EdicaoStatusResultadoSindicoPage implements OnInit {
  assunto: string = "";
  conteudo: string = "";
  pauta_id: string = "";
  status: string = "";
