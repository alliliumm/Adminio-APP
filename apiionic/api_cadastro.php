...
/*Cadastrar Síndico*/
    ...
    $senha_cript = md5($postjson['senha_crip']);

    $query = $pdo->prepare("INSERT INTO sindicos SET nome = :nome, tipo_sindico = :tipo_sindico, sindico_condominioo_id = :sindico_condominioo_id, email_sin = :email_sin, senha_sin = :senha_sin, senha_crip = :senha_crip");
...
/*Cadastrar usuário*/ 
    ...
    $query = $pdo->prepare("INSERT INTO condominos SET condnome = :condnome, tipo_condomino = :tipo_condomino, condominos_condominioo_id = :condominos_condominioo_id, conjunto= :conjunto, bloco =:bloco, andar =:andar, apartamento = :apartamento, email_cond = :email_cond, senha_cond = :senha_cond, senha_crip = :senha_crip");
